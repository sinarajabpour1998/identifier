                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="group segment-content">
                                        ...
                                        <a type="button" class="primary-btn radius-5px confirm_sms_code" href="#">
                            ...
                            <div class="col-md-12">
                                <h4 class="head-title text-center mb-0">
                                        <span class="mobile_number">
                                            شماره موبایل <span class="mobile_num">{{ request()->cookie('identifier_username') }}</span> در {{ config('identifier.site_title') }} ثبت نشده
                                        </span>
                                </h4>
                            </div>
                        </div>
