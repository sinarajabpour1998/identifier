<div>
    <div class="card-body p-0">
        <div class="identifier-login-form">
            <div class="auth-wrapper">
                @switch($page)
                    @case('default')
                        <div class="segment">
                            <div class="segment-content">
                                <div class="create-account-text">اگر در {{ config('identifier.site_title') }} حساب کاربری ندارید، ثبت نام کنید:</div>
                                <a type="button" class="primary-btn radius-5px create_account" href="#">
                        ...
                        <div class="segment">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="login-if-exist mb-2">اگر در {{ config('identifier.site_title') }} حساب کاربری دارید، وارد شوید:</div>
                                    <div class="form-group">
                                        <div class="group segment-content">
                                            ...
                                            <a type="button" class="primary-btn radius-5px account_login" href="#">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="group segment-content">
                                            ...
                                            <a type="button" class="primary-btn radius-5px code_step" href="#">
                                                <span class="text">ورود</span>
                                                <span class="fa fa-sign-in fa-fw fa-display"></span>
                                                <div class="overlay"></div>
                                            </a>
                                    ...
                                    <p>
                                        قوانین <a href="{{ config('identifier.terms_url') }}" class="forgot-password">{{ config('identifier.site_title') }}</a> را مطالعه کرده‌ام و قبول دارم.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="">
                                        <span class="mobile-code-text">
                                            <i class="sms-icon"></i>
                                            کد فرستاده شده برای  <span class="mobile_num"></span>  را وارد کنید
                                        </span>
                                    </div>
                                    <div class="form-group">
                                        <div class="group segment-content">
                                            ...
                                            <a type="button" class="primary-btn radius-5px confirm_sms_code" name="confirm_sms_code" href="#">
                                                <span class="text">تایید</span>
                                                <span class="fa fa-check fa-fw fa-display"></span>
                                                <div class="overlay"></div>
                                            </a>
                                        </div>
                                        <span class="invalid-feedback mt-2 d-none">
                                            <strong></strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <h4 class="head-title text-center mb-0">
                                        <span class="mobile_number">
                                            شماره موبایل <span class="mobile_num"></span> در {{ config('identifier.site_title') }} ثبت نشده
                                        </span>
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="group segment-content">
                                        ...
                                        <a type="button" class="primary-btn radius-5px forget_action" href="#">
                                            <span class="text">ورود</span>
                                            <span class="fa fa-sign-in fa-fw fa-display"></span>
                                            <div class="overlay"></div>
                                        </a>
                    ...
                    <div class="segment">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                        <span class="mobile-code-text">
                                            کد فرستاده شده برای  <span class="user_info"></span>  را وارد کنید
                                        </span>
                                </div>
                                <div class="form-group">
                                    <div class="group segment-content">
                                        ...
                                        <a type="button" class="primary-btn radius-5px confirm_recovery_code" href="#">
                                            <span class="text">تایید</span>
                                            <span class="fa fa-check fa-fw fa-display"></span>
                                            <div class="overlay"></div>
                                        </a>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="group segment-content">
                                        ...
                                        <a class="primary-btn radius-5px login_with_password float-left mr-2" href="#">
                                            ورود
                                        </a>
                                    </div>
                                    <span class="invalid-feedback mt-4 d-none">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="group segment-content">
                                        ...
                                        <a type="button" class="primary-btn radius-5px confirm_email_code" href="#">
                                            <span class="text">تایید</span>
                                            <span class="fa fa-check fa-fw fa-display"></span>
                                            <div class="overlay"></div>
                                        </a>
