...
<head>
    ...
    <title>ورود به {{ config('identifier.site_title') }}</title>
    ...
    <!-- Styles -->
    <link href="{{ mix(config('identifier.css_public_path')) }}" rel="stylesheet">
...
<script src="{{ mix(config('identifier.js_public_path')) }}"></script>
@yield('script')
